...
// Setup Config
var configDir = Directory.EnumerateDirectories(AppDomain.CurrentDomain.BaseDirectory, "*", SearchOption.TopDirectoryOnly)
    .FirstOrDefault(d => string.Equals(Path.GetFileName(d), "Config", StringComparison.OrdinalIgnoreCase));    
var configPath = configDir ?? Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config");
