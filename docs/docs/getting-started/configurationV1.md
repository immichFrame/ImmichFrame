...
| [Filtering](#filtering) | ShowOnlyAssetsInAlbums     | boolean                             | false                                          | If this is set, only assets that are part of any album are displayed. `ExcludedAlbums` still applies.                                  |
