...
| **Required**            | **ApiKey**                 | **string**                          |                      | **Read more about how to obtain an [Immich API key](https://immich.app/docs/features/command-line-interface/#obtain-the-api-key).**		|
...
| [Weather](#weather)     | WeatherApiKey              | string                              |                      | Get an API key from [OpenWeatherMap](https://openweathermap.org/appid).                                                                      |
