namespace ImmichFrame.Core.Interfaces
{
    ...
    {
        public IEnumerable<IImmichAccountSettings> Accounts { get; set; }
        public IImmichFrameSettings ImmichFrameSettings { get; set; }
    }

    public interface IImmichFrameSettings
    {
    ...
    public interface IImmichAccountSettings
    {
