...
namespace ImmichFrame.Core.Logic
{
    ...
    {
        private IImmichAccountSettings _accountSettings;
        private IImmichFrameSettings _frameSettings;
        public ImmichFrameLogic(IImmichAccountSettings accountSettings, IImmichFrameSettings frameSettings)
        {
